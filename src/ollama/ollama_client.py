...
import time
import threading
from typing import Optional, Dict, List, Callable, Any, Generator, Union
import logging
...
class OllamaClient:
    ...
    def generate(self, model: str, prompt: str, 
        ...
        Returns:
            Generated text (str) if stream=False, Generator if stream=True, or None if error
        """
    ...
    def chat(self, model: str, messages: List[Dict[str, str]], 
        ...
        Returns:
            Generated response (str) if stream=False, Generator if stream=True, or None if error
        """
